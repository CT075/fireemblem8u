...
// ??? sub_8029544(???);
// ??? GenericStaffSelection_OnSelect(???);
// ??? PrepareTargetSelectionForRescueStaff(???);
// ??? SetupTargetSelectionForGenericStaff(???);
// ??? WarpTargetPosSelect_Init(???);
// ??? WarpTargetPosSelect_Loop(???);
// ??? WarpTargetPosSelect_Confirm(???);
// ??? WarpTargetPosSelect_Cancel(???);
// ??? WarpTargetPosSelect_Destruct(???);
// ??? WarpTargetSelection_OnSelect(???);
// ??? SetupWarpTargetSelection(???);
// ??? sub_80298D4(???);
// ??? PrepareTargetSelectionForMineAndLightRune(???);
// ??? HammerneTargetSelection_OnSelect(???);
// ??? SetupHammerneUseSelection(???);
// ??? HammerneTargetSelection_OnChange(???);
// ??? HammerneTargetSelection_OnInit(???);
// ??? sub_8029A38(???);
// ??? nullsub_24(???);
// ??? sub_8029A4C(???);
// ??? sub_8029A84(???);
// ??? sub_8029AE0(???);
// ??? PrepareTargetSelectionForHeal(???);
// ??? PrepareTargetSelectionForRestoreStaff(???);
// ??? sub_8029C04(???);
// ??? sub_8029C10(???);
// ??? sub_8029C34(???);
// ??? sub_8029C70(???);
...
// ??? sub_8029D38(???);
// ??? sub_8029D6C(???);
// ??? TorchTargetPosSelect_Init(???);
// ??? TorchTargetSelection_Loop(???);
// ??? NewTorchStaffSelection(???);
